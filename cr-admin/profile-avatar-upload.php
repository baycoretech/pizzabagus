<div id="crop-avatar" class="panel-body">
    <div class="form-group">
        <div class="avatar-view" title="Change profile photo">
            <img id="gambarAvatar" src="<?php echo MADMINURL ?><?php if($action == 'add') { echo "assets/img/no-pic.png"; } elseif($action == 'edit') { if($function_edit_administrator->cr_adminPhoto == '') echo "assets/img/no-pic.png"; else echo $function_edit_administrator->cr_adminPhoto; } else { echo "";} ?>" alt="Profile Photo">
        </div>
    </div>
    <!-- Cropping modal -->
    <div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
        ...
        <div class="modal-content">
            <form class="avatar-form" action="<?php echo MADMINURL ?>crop-avatar.php" enctype="multipart/form-data" method="post">
            <div class="modal-header">
                <button class="close" data-dismiss="modal" type="button">&times;</button>
                <h4 class="modal-title" id="avatar-modal-label">Change Profile Photo</h4>
            </div>
