<?php
    ...
    $view_sent    = $class_mail->view_sent_all($admin_id_session);
?>
<!-- begin vertical-box -->
    ...
    <div class="vertical-box-column width-250">
        ...
        <div class="wrapper">
            ...
            <ul class="nav nav-pills nav-stacked nav-sm">
                ...
                <li class="active"><a href="<?php echo $router->generate('admin-dashboard-section', array('section' => 'sent')) ?>"><i class="fa fa-send fa-fw m-r-5"></i> Sent <?php if($total_sent != 0) { ?><span class="badge badge-square pull-right"><?php echo $total_sent ?></span><?php } ?></a></li>
    ...
    <div class="vertical-box-column">
        ...
        <ul class="list-group list-group-lg no-radius list-email">
            ...
            <li class="list-group-item <?php echo $label ?>">
                <a href="<?php echo $router->generate('admin-dashboard-action', array('section' => 'sent', 'action' => $data->cr_inboxID)) ?>" class="email-user">
                ...
                <div class="email-info">
                    ...
                    <h5 class="email-title">
                        <a href="<?php echo $router->generate('admin-dashboard-action', array('section' => 'sent', 'action' => $data->cr_inboxID)) ?>">To: <?php echo ucwords($data->cr_adminDisplayName) ?> - <em><?php echo $data->cr_inboxSubject ?></em></a>
        ...
        <div class="wrapper bg-silver-lighter clearfix">
            <div class="m-t-5"><?php if($total_sent == 0) echo "You have no message right now"; elseif($total_sent == 1) echo $total_sent." message"; else echo $total_sent." messages" ?></div>
        </div>
        <?php
            }
        ?>
