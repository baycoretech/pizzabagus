<?php
	...
	elseif($photo==MURL."/cr-include/images/default-post-image.png") {
		echo "image-empty";
	}
	...
	elseif(strlen($metadesc)>155) {
		...
		if($v_checkBlogTitle==0) {
    		$v_getUpdateImagePost = $o_getBlog->updateBlogImage($title, $content, $blogtype, $tags, $noimplodetags, $photo, $photourlnc, $cat, $status, $comment, $metakey, $metadesc, $blogIDh, $adminLoginID);
    		echo "success";
    	}
    	else {
    		echo "same-title";
