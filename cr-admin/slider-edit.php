<?php
    ...
    $function_edit_slider = $class_slider->edit_slider_image($id);
?>
<div class="row">
    <!-- begin col-8 -->
    <div class="col-md-8">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <div id="" class="panel-body">
                    <form id="form-edit-slider" data-parsley-validate action="" method="POST">
                        <input type="hidden" name="slider_idh" value="<?php echo $id ?>">
                        <input id="mediafile" type="hidden" name="photo" value="<?php echo $function_edit_slider->cr_sliderImage ?>">
                        <div class="form-group">
                            <div class="note note-info">
                               Use tag <code>&lt;br&gt;</code> to break the caption or description if you find your text is to long on screen.        
                            </div>
                            <label class="control-label">Caption</label>
                            <input class="form-control" placeholder="Slider Image Caption" type="text" name="caption" value="<?php echo $function_edit_slider->cr_sliderCaption ?>" data-parsley-maxlength="100">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Description</label>
                            <textarea name="desc" class="form-control" rows="3" placeholder="Slider Image Description"><?php echo $function_edit_slider->cr_sliderDesc ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Link</label>
                            <input class="form-control" placeholder="Slider Image Link" type="text" name="blink" value="<?php echo $function_edit_slider->cr_sliderButtonlink ?>" data-parsley-type="url" data-parsley-maxlength="255">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Text Position</label>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="textposition" value="left" <?php if($function_edit_slider->cr_sliderTextposition == "left") echo 'checked=checked'; ?>>
                                    Left
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="textposition" value="center" <?php if($function_edit_slider->cr_sliderTextposition == "center") echo 'checked=checked'; ?>>
                                    Center
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="textposition" value="right" <?php if($function_edit_slider->cr_sliderTextposition == "right") echo 'checked=checked'; ?>>
                                    Right
                                </label>
                            </div>
                        </div>
            ...
            <div class="panel-footer">
                <button id="button-edit-slider" type="submit" class="btn btn-success m-r-5 m-b-5" name="save"><i class="fa fa-check"></i> Save</button>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <div id="used-image-container">
                    <img id="used-image" style="width: 100%" src="<?php echo MURL."/cr-editor/images/".$function_edit_slider->cr_sliderImage ?>">
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var edit_slider_image;
        $("#form-edit-slider").submit(function(event){
            if ($(this).parsley().isValid()) {
                if (edit_slider_image) {
                    edit_slider_image.abort();
                }
                var $form = $(this);
                var $inputs = $form.find("input, button");
                var serializedData = $form.serialize();
                edit_slider_image = $.ajax({
                    url: "<?php echo MADMINURL ?>ajax/slider-update.php",
                    type: "post",
                    beforeSend: function(){ $("#button-edit-slider").html('<i class="fa fa-spinner fa-pulse"></i> Saving...');$("#button-edit-slider").attr('disabled','disabled');},
                    data: serializedData
                });
                edit_slider_image.done(function (msg){
                    if(msg == 'caption-long') {
                        $("#button-edit-slider").removeAttr('disabled');
                        $("#button-edit-slider").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Failed! Slider caption is too long",
                            text:"Can't update slider. It should have 100 characters or less. Please try again.",
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't update slider. It should have 255 characters or more. Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't update slider. Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't update slider. You have to upload the slider image. Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                        ...
                        $("#button-edit-slider").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Failed! Can't update slider",
                        ...
                        $("#button-edit-slider").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Error! Can't update slider",
                            text:"Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                ...
                edit_slider_image.always(function () {
