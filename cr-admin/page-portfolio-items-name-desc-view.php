<?php
    ...
    $v_getPortfolio  = $o_getPortfolio->viewPortfolionameDESC($pagelink);
?>
<div id="options" class="m-b-10">
    ...
    <div class="btn-group m-t-15 m-r-15 pull-right">
        ...
        <a id="sort-desc" href="<?php echo MADMINURL ?>/page/<?php echo $pagelink ?>/view-name-desc" class="btn btn-inverse active" title="Sort by name (descending)"><i class="fa fa-sort-alpha-desc"></i></a>
