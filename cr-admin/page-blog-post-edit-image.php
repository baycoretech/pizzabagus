...
<div class="row">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <form id="form-edit-post" data-parsley-validate action="" method="POST">
                    ...
                    <input type="hidden" name="blogtype" value="image">
                    <input type="hidden" name="blog_idh" value="<?php echo $extra ?>">
                    <input id="photourlnc" type="hidden" name="photourlnc" value="<?php echo $function_edit_blog->cr_blogFeatured ?>">
                    <legend>Post</legend>
    ...
    <div class="col-md-4">
        <div class="panel panel-inverse">
            ...
            <?php require "blog-post-upload.php" ?>
         </div>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        $("#form-edit-post").submit(function(event){
            if ($(this).parsley().isValid()) {
                ...
                edit_post = $.ajax({
                    url: "<?php echo MADMINURL ?>ajax/blog-post-image-update.php",
                    type: "post",
                ...
                edit_post.done(function (msg){
                    ...
                    else if(msg == 'image-empty') {
                        $(".button-cancel").removeAttr('disabled');
                        $("#button-edit-post").removeAttr('disabled');
                        $("#button-edit-post").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Failed! Featured image is empty",
                            text:"Can't update post. Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
