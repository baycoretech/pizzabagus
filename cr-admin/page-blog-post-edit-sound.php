            ...
            <div class="panel-body">
                <form id="form-edit-post" data-parsley-validate action="" method="POST">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input class="form-control" placeholder="Soundcloud Embed Link" type="text" name="link" value="<?php echo $function_edit_blog->cr_blogFeatured ?>" data-parsley-minlength="4" data-parsley-maxlength="500" data-parsley-type="url" required>
    ...
    $(document).ready(function() {
        ...
        $("#form-edit-post").submit(function(event){
            if ($(this).parsley().isValid()) {
                ...
                edit_post = $.ajax({
                    url: "<?php echo MADMINURL ?>ajax/blog-post-sound-update.php",
                    type: "post",
