        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8">
                            <form id="formaddbanner" data-parsley-validate action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Banner Link" type="text" name="link" data-parsley-minlength="1" data-parsley-maxlength="255" data-parsley-type="url" required>
                                </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Used Image</label>
                                <img id="used-image" style="width: 100%" src="<?php echo MADMINURL."/assets/img/no-pic-items-wide.png" ?>">
                            </div>
                        </div>
                    </div>
                </div>
            <div class="panel-footer">
                <button id="submitaddbanner" type="submit" class="btn btn-success m-r-5 m-b-5" name="save"><i class="fa fa-check"></i> Save</button>
...
<script>
        $(document).ready(function() {
            ...
            var requestaddbanner;
            $("#formaddbanner").submit(function(event){
                if (requestaddbanner) {
                    requestaddbanner.abort();
                }
                var $form = $(this);
                var $inputs = $form.find("input, button");
                var serializedData = $form.serialize();
                requestaddbanner = $.ajax({
                    url: "<?php echo MADMINURL ?>/banner-add-ajax.php",
                    type: "post",
                    beforeSend: function(){ $("#submitaddbanner").html('<i class="fa fa-spinner fa-pulse"></i> Saving...');},
                    data: serializedData
                });
                requestaddbanner.done(function (msg){
                    if(msg=='link-long') {
                        $("#submitaddbanner").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Failed! Banner link is too long",
                            text:"Can't add new banner. It should have 255 characters or less. Please try again.",
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't add new banner. Please try again.",
                            image:"<?php echo MADMINURL.'/assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't add new banner. You have to upload the image. Please try again.",
                            image:"<?php echo MADMINURL.'/assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                ...
                requestaddbanner.always(function () {
