<?php
    ...
    $function_edit_gallery = $class_gallery->edit_gallery($extra);
?>
<div class="row">
    <div class="col-md-8">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <form id="form-edit-gallery" data-parsley-validate action="" method="POST">
                    <input type="hidden" name="gallery_idh" value="<?php echo $extra ?>">
                    <input type="hidden" name="link" value="<?php echo $action ?>">
                    <input id="mediafile" type="hidden" name="photo" value="<?php echo $function_edit_gallery->cr_galleryThumb ?>">
                    <div class="form-group">
                        <label class="control-label">Title</label>
                        <input class="form-control" placeholder="Picture Title" type="text" name="title" value="<?php echo $function_edit_gallery->cr_galleryTitle ?>" data-parsley-maxlength="255" required>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Description</label>
                        <textarea name="desc" class="form-control" rows="3" placeholder="Picture Description"><?php echo $function_edit_gallery->cr_galleryDesc ?></textarea>
                    </div>
            </div>
            <div class="panel-footer">
                    <button id="button-edit-gallery" type="submit" class="btn btn-success m-r-5 m-b-5"><i class="fa fa-check"></i> Save</button>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <div id="used-image-container">
                    <img id="used-image" style="width: 100%" src="<?php echo MURL."/cr-editor/images/".$function_edit_gallery->cr_galleryThumb ?>">
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var edit_gallery;
        $("#form-edit-gallery").submit(function(event){
            if (edit_gallery) {
                edit_gallery.abort();
            }
            var $form = $(this);
            ...
            edit_gallery = $.ajax({
                url: "<?php echo MADMINURL ?>ajax/gallery-update.php",
                type: "post",
                beforeSend: function(){ $("#button-edit-gallery").html('<i class="fa fa-spinner fa-pulse"></i> Saving...');$("#button-edit-gallery").attr('disabled','disabled');$(".button-cancel").attr('disabled','disabled')},
                data: serializedData
            });
            edit_gallery.done(function (msg){
                if(msg == 'empty-field') {
                    $(".button-cancel").removeAttr('disabled');
                    $("#button-edit-gallery").removeAttr('disabled');
                    $("#button-edit-gallery").html('<i class="fa fa-check"></i> Save');
                    $.gritter.add({
                        title:"Failed! Please fill all required field",
                        text:"Can't update picture. Please try again.",
                    ...
                    $.gritter.add({
                        ...
                        text:"Can't update picture. It should have 255 characters or less. Please try again.",
                        image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                        sticky:false,
                        time:""
                    });
                    ...
                    $.gritter.add({
                        ...
                        text:"Can't update picture. You have to upload the picture. Please try again.",
                        image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                        sticky:false,
                        time:""
                    });
                    ...
                    $("#button-edit-gallery").html('<i class="fa fa-check"></i> Save');
                    $.gritter.add({
                        title:"Failed! Can't update picture",
                    ...
                    $("#button-edit-gallery").html('<i class="fa fa-check"></i> Save');
                    $.gritter.add({
                        title:"Error! Can't update picture",
                        text:msg,
                        image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                        sticky:false,
                        time:""
