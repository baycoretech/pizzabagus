            ...
            <div class="panel-body">
                <form id="form-add-post" data-parsley-validate action="" method="POST">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input class="form-control" placeholder="Youtube Embed Video Link" type="text" name="link" data-parsley-minlength="4" data-parsley-maxlength="500" data-parsley-type="url" required>
                        <span class="fa fa-youtube-play form-control-feedback"></span>
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $("#form-add-post").submit(function(event){
            if ($(this).parsley().isValid()) {
                ...
                add_post = $.ajax({
                    url: "<?php echo MADMINURL ?>ajax/blog-post-video-add.php",
                    type: "post",
