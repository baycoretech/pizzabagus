<?php
    ...
    if(empty($name) || empty($desc)) {
	    ...
	    if(!empty($name) && strlen($name)>100) {
	    	...
	    	$function_update_services = $class_services->update_services($photo, $name, $desc, $service_idh, $admin_login_id, $now_date);
	    	if($function_update_services == true) 
		    	echo 'true';
		    else 
		    	echo 'false';
	    }
