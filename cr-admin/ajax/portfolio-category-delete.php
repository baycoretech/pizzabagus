<?php
    ...
    if(empty($pc_id)){
        ...
        $function_delete_portfolio_category = $class_portfolio_category->delete_portfolio_category($pc_id, $admin_login_id, $now_date);
        if($function_delete_portfolio_category == true) {
