<?php
    ...
    $cat             = $_POST['cat'];
    $status          = $_POST['status'];
    $photourlnc      = $_POST['photourlnc'];
    $ourmenu_idh     = $_POST['ourmenu_idh'];
		...
		*/
		    ...
		    elseif($title == "sort" || $title == "Sort") {
	        	echo "reserved-word";
		      	...
		      	$function_check_update_name_ourmenu = $class_ourmenu->check_update_name_ourmenu($title, $ourmenu_idh);
		        if($function_check_update_name_ourmenu == true) {
		        	echo "same-title";
		        }
		        else {
		        	//Set timezone
			        ...
			        $function_update_ourmenu = $class_ourmenu->update_ourmenu($title, $ingredients, $ingredients_id, $noimplodeingredients, $noimplodeingredients_id, $desc, $desc_id, $photo, $photourlnc, $cat, $status, $price, $size, $type, $admin_login_id, $now_date, $ourmenu_idh);
			        if($function_update_ourmenu == true) 
				    	echo 'true';
				    else 
				    	echo 'false';
			    }
