<?php
    ...
    if(isset($_POST['delete-blog'])) {
		...
		foreach($blog_id as $delete) {
	    	$function_delete_blog = $class_blog->delete_blog($delete, $admin_login_id, $now_date);
	    }
	    if($function_delete_blog == true) 
		    echo 'true';
		else 
		  	echo 'false';
	}
