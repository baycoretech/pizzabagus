<?php
    ...
    if(empty($status)) {
	    ...
	    $function_change_invoice_delivery = $class_invoice->change_invoice_delivery($invoice_id, $status, $admin_login_id, $now_date);
	    if($function_change_invoice_delivery == true) 
		    echo 'true';
		else 
		  	echo 'false';
	}
