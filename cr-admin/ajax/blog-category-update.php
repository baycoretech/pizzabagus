    ...
    if(empty($name)){
	    ...
	    elseif($name == "page" || $name == "tag" || $name == "cat") {
	    	...
	    	if($check_name == true) {
	            ...
	            $function_update_blog_category = $class_blog_category->update_blog_category($name, $name_old, $bc_idh, $admin_login_id, $now_date);
	            if($function_update_blog_category == true) {
