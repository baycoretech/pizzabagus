<?php
    ...
    $value           = "enable";
	$setting_name    = "maintenance mode";
    $setting_name_2  = "date and time for maintenance";
    $setting_idhe    = $_POST['settingIDhe'];
    $setting_idhm    = $_POST['settingIDhm'];
    $date_time		 = $_POST['datemaintenance'].' '.$_POST['timemaintenance'];
    ...
    if(empty($setting_idhe)) {
    	...
    	$function_set_date_time = $class_settings->update_settings($date_time, $setting_name_2, $admin_login_id, $setting_idhm, $now_date);
    	$function_enable_maintenance = $class_settings->update_settings($value, $setting_name, $admin_login_id, $setting_idhe, $now_date);
    	if($function_set_date_time == true && $function_enable_maintenance == true) 
