<?php
    ...
    if(empty($social)) {
		...
		elseif(!empty($customdesc_id) && strlen($customdesc_id) > 500) {
	    	...
	    	$function_update_contact = $class_contact->update_contact($desc, $desc_id, $social, $customheader, $customheader_id, $customdesc, $customdesc_id, $link, $contact_idh, $admin_login_id, $now_date);
	    	if($function_update_contact == true) 
		    	echo 'true';
		    else 
		    	echo 'false';
	    }
