<?php
    ...
    $portfolio_extra_id    = $_POST['portfolio_extra_id'];
    $admin_login_id = $_SESSION['cr_adminID'];

    if(empty($portfolio_extra_id)) {
		echo "portfolio-extra-empty";
	}
	else {
		//Set timezone
	    ...
	    $function_delete_portfolio_extra = $class_portfolio_extra->delete_portfolio_extra($portfolio_extra_id, $admin_login_id, $now_date);
	    if($function_delete_portfolio_extra == true) 
		    echo 'true';
		else 
		  	echo 'false';
	}
