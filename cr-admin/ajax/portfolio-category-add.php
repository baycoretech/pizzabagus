    ...
    if(empty($name)){
	    ...
	    elseif(!empty($name) && strlen($name) < 3) {
	    	...
	    	if($check_name == true) {
	            ...
	            $function_add_portfolio_category = $class_portfolio_category->add_portfolio_category($name, $page_link, $admin_login_id, $now_date);
	            if($function_add_portfolio_category == true) {
