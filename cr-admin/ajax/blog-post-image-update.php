    	...
    	if($photo == MURL."cr-include/images/default-post-image.png") {
		    ...
		    elseif(strlen($metadesc) > 155) {
		        ...
		        if($function_check_blog_name_edit == true) {
			        ...
			        $function_update_blog_image = $class_blog->update_blog_image($title, $content, $blog_type_id, $tags, $noimplodetags, $photo, $photourlnc, $cat, $status, $comment, $metakey, $metadesc, $blog_idh, $admin_login_id, $now_date);
			        if($function_update_blog_image == true) 
				    	echo 'true';
				    else 
				    	echo 'false';
			    }
