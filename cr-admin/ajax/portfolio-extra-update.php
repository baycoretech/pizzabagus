<?php
    ...
    $portfolio_extra_idh = $_POST['portfolio_extra_idh'];
    ...
    if(empty($name) || empty($content)) {
		...
		elseif(strlen($content) < 1) {
	        ...
	        $function_update_portfolio_extra = $class_portfolio_extra->update_portfolio_extra($name, $content, $portfolio_id, $admin_login_id, $now_date, $portfolio_extra_idh);
	        if($function_update_portfolio_extra == true) 
		    	echo 'true';
		    else 
		    	echo 'false';
		}
