<?php
    ...
    $value            = $_POST['color_scheme'];
    $custom_primary   = $_POST['custom_primary'];
    $custom_secondary = $_POST['custom_secondary'];
    ...
    if(empty($value)){
    	...
    	$function_update_color_scheme = $class_appearance->update_color_scheme($value, $custom_primary, $custom_secondary, $admin_login_id, $now_date);
    	if($function_update_color_scheme == true) 
    		echo 'true';
    	else 
    		echo 'false';
    }
