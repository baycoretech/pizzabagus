<?php
    ...
    if(empty($photo)) {
		...
		elseif(!empty($blink) && filter_var($blink, FILTER_VALIDATE_URL) === false) {
	    	...
	    	$function_add_slider_image = $class_slider->add_slider_image($photo, $caption, $desc, $blink, $textposition, $admin_login_id, $now_date);
	    	if($function_add_slider_image == true) 
		    	echo 'true';
		    else 
		    	echo 'false';
	    }
