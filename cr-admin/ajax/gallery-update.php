    ...
    if(empty($title)) {
	    ...
	    if(empty($photo)) {
		    ...
		    if(!empty($title) && strlen($title) > 255) {
		    	...
		    	$function_update_gallery = $class_gallery->update_gallery($title, $desc, $photo, $link, $admin_login_id, $gallery_idh, $now_date);
		    	if($function_update_gallery == true) 
			    	echo 'true';
			    else 
			    	echo 'false';
		    }
