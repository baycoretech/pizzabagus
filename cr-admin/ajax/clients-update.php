<?php
    ...
    if(empty($name)) {
		...
		elseif(!empty($link) && filter_var($link, FILTER_VALIDATE_URL) === false) {
	    	...
	    	$function_update_clients = $class_clients->update_clients($name, $link, $photo, $admin_login_id, $client_idh, $now_date);
	    	if($function_update_clients == true) 
		    	echo 'true';
		    else 
		    	echo 'false';
	    }
