    ...
    <div class="col-md-8">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <form id="form-add-page" data-parsley-validate action="" method="POST">
                    ...
                    <div class="tab-content m-b-0">
                        <div role="tabpanel" class="tab-pane fade in active" id="tab_en">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Page Title" type="text" name="title" data-parsley-maxlength="100" required>
                            </div>
                            <?php 
                                if($page_column == 1) {
                            ?>
                            <div class="form-group">
                                ...
                                <textarea name="editor1" rows="30"></textarea>
                            </div>
                            <?php
                                }
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="editor2" rows="30"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label">Column 1</label>
                                <textarea id="editor1" name="editor1" rows="30"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Column 2</label>
                                <textarea id="editor2" name="editor2" rows="30"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Column 3</label>
                                <textarea name="editor3" rows="30"></textarea>
                            </div>
                            <?php
                                }
                            ?>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_id">
                            <div class="form-group">
                                <label class="control-label">Page Title</label>
                                <input class="form-control" placeholder="Page Title" type="text" name="title_id" data-parsley-maxlength="100" required>
                            </div>
                            <?php 
                                if($page_column == 1) {
                            ?>
                            <div class="form-group">
                                <label class="control-label">Column 1</label>
                                <textarea name="editor1_id" rows="30"></textarea>
                            </div>
                            <?php
                                }
                                elseif($page_column == 2) {
                            ...
                            <div class="form-group">
                                <label class="control-label">Column 2</label>
                                <textarea name="editor2_id" rows="30"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label">Column 1</label>
                                <textarea id="editor1_id" name="editor1" rows="30"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Column 2</label>
                                <textarea id="editor2_id" name="editor2" rows="30"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Column 3</label>
                                <textarea name="editor3_id" rows="30"></textarea>
                            </div>
                            <?php
                                }
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Meta Keywords" type="text" name="metakeywords" data-parsley-maxlength="255">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Meta Description</label>
                        <textarea class="form-control" placeholder="Meta Description" name="metadesc" rows="5" data-parsley-maxlength="155"></textarea>
                    </div>
            </div>
            <div class="panel-footer">
                    <button id="button-add-page" type="submit" class="btn btn-success m-r-5 m-b-5"><i class="fa fa-check"></i> Save</button>
    ...
    $(document).ready(function() {
        ...
        $("#form-add-page").submit(function(event){
            if ($(this).parsley().isValid()) {
                ...
                add_page = $.ajax({
                    url: "<?php echo MADMINURL ?>ajax/page-general-add.php",
                    type: "post",
                    beforeSend: function(){ $("#button-add-page").html('<i class="fa fa-spinner fa-pulse"></i> Saving...');$("#button-add-page").attr('disabled','disabled');$(".button-cancel").attr('disabled','disabled')},
                    data: serializedData
                });
                add_page.done(function (msg){
                    if(msg == 'empty-field') {
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't add new page. Please try again.",
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't add new page. It should have 100 characters or less. Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                        ...
                        $("#button-add-page").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Failed! Can't add new page",
                        ...
                        $("#button-add-page").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Error! Can't add new page",
                            text:msg,
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
