<?php
    ...
    $function_edit_bank_account = $class_bank->edit_bank_account($id);
?>
<div class="row">
    <!-- begin col-8 -->
    <div class="col-md-8">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <div id="" class="panel-body">
                    <form id="form-edit-bank" data-parsley-validate action="" method="POST">
                        <input type="hidden" name="bank_idh" value="<?php echo $id ?>">
                        <input id="mediafile" type="hidden" name="image" value="<?php echo $function_edit_bank_account->cr_banksImage ?>">
                        <div class="form-group">
                            <label class="control-label">Bank Name</label>
                            <input class="form-control" placeholder="Bank Name" type="text" name="name" data-parsley-maxlength="100" value="<?php echo $function_edit_bank_account->cr_banksName ?>" required>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Account Number</label>
                            <input class="form-control" placeholder="Account Number" type="text" name="number" data-parsley-maxlength="100" value="<?php echo $function_edit_bank_account->cr_banksNumber ?>" required>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Owner</label>
                            <input class="form-control" placeholder="Owner" type="text" name="owner" data-parsley-maxlength="255" value="<?php echo $function_edit_bank_account->cr_banksOwner ?>" required>
                        </div>
                </div>
            <div class="panel-footer">
                <button id="button-edit-bank" type="submit" class="btn btn-success m-r-5 m-b-5"><i class="fa fa-check"></i> Save</button>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <div id="used-image-container">
                    <img id="used-image" style="width: 100%" src="<?php echo MURL."/cr-editor/images/".$function_edit_bank_account->cr_banksImage ?>">
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var edit_bank;
        $("#form-edit-bank").submit(function(event){
            if ($(this).parsley().isValid()) {
                ...
                edit_bank = $.ajax({
                    url: "<?php echo MADMINURL ?>ajax/bank-account-update.php",
                    type: "post",
                    beforeSend: function(){ $("#button-edit-bank").html('<i class="fa fa-spinner fa-pulse"></i> Saving...');$("#button-edit-bank").attr('disabled','disabled');},
                    data: serializedData
                });
                edit_bank.done(function (msg){
                    if(msg == 'name-long') {
                            $("#button-edit-bank").removeAttr('disabled');
                            $("#button-edit-bank").html('<i class="fa fa-check"></i> Save');
                            $.gritter.add({
                        ...
                        $.gritter.add({
                            ...
                            text:"Can't update bank account. You have to upload the bank image. Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                        ...
                        $.gritter.add({
                            title:"Success!",
                            text:"Bank account has been updated.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
                        });
                        ...
                        $("#button-edit-bank").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Failed! Can't update bank account",
                        ...
                        $("#button-edit-bank").html('<i class="fa fa-check"></i> Save');
                        $.gritter.add({
                            title:"Error! Can't update bank account",
                            text:"Please try again.",
                            image:"<?php echo MADMINURL.'assets/img/cr.png' ?>",
                            sticky:false,
                            time:""
