...
;(function($) {
	...
	$.fn.SuperBox = function(options) {
		...
		var superbox      = $('<div class="superbox-show"></div>'),
			superboximg   = $('<img src="" class="superbox-current-img"><div id="imgInfoBox" class="superbox-imageinfo inline-block"> <h4 class="text-white">Image Title</h4><span><p class="superbox-img-description">Image description</p><p><button id="egal-button" class="btn btn-success" onclick="">Edit Image</button> <button class="btn btn-danger">Delete</button></p></span> </div>'),
		...
		return this.each(function() {
			...
			$('.superbox-list').click(function() {
				...
				var currentimg = $this.find('.superbox-img'),
					...
					editclick = "location.href='<?php echo MADMINURL; ?>/menu/add/"+ imgID +"'";
