				...
				$.get(''+options.xmlUrl+'', function(d){
					$(d).find('event').each(function(){
						...
						var fullstartDate = $(this).find('startdate').text(),
							...
							eventBorder = $(this).find('bordercolor').text(),
						...
						function multidaylist(){
							...
							$('#'+uniqueId+' .monthly-list-item[data-number="'+i+'"]').addClass('item-has-event').append('<a href="'+eventURL+'" class="listed-event"  data-eventid="'+ eventId +'" style="background:'+eventColor+'; border-left:8px solid '+eventBorder+'" title="'+eventTitle+'">'+eventTitle+' '+timeHtml+'</a>');
						}
						...
						if (!fullendDate && startMonth == setMonth && startYear == setYear) {
							// Add Indicators
							$('#'+uniqueId+' *[data-number="'+startDay+'"] .monthly-indicator-wrap').append('<div class="monthly-event-indicator"  data-eventid="'+ eventId +'" style="background:'+eventColor+'; border-left:8px solid '+eventBorder+'" title="'+eventTitle+'">'+eventTitle+'</div>');
							...
							$('#'+uniqueId+' .monthly-list-item[data-number="'+startDay+'"]').addClass('item-has-event').append('<a href="'+eventURL+'" class="listed-event"  data-eventid="'+ eventId +'" style="background:'+eventColor+'; border-left:8px solid '+eventBorder+'" title="'+eventTitle+'">'+eventTitle+' '+timeHtml+'</a>');
						...
						// If event is multi day & within month
							...
							for(var i = parseInt(startDay); i <= parseInt(endDay); i++) {
								...
								if (i == parseInt(startDay)) {
									$('#'+uniqueId+' *[data-number="'+i+'"] .monthly-indicator-wrap').append('<div class="monthly-event-indicator" data-eventid="'+ eventId +'" style="background:'+eventColor+'; border-left:8px solid '+eventBorder+'" title="'+eventTitle+'">'+eventTitle+'</div>');
								} else {
						...
						// If event is multi day, starts in prev month, and ends in current month
							...
							for(var i = 0; i <= parseInt(endDay); i++) {
								...
								if (i==1){
									...
									$('#'+uniqueId+' *[data-number="'+i+'"] .monthly-indicator-wrap').append('<div class="monthly-event-indicator" data-eventid="'+ eventId +'" style="background:'+eventColor+'; border-left:8px solid '+eventBorder+'" title="'+eventTitle+'"></div>');
								}
								multidaylist();
							}
