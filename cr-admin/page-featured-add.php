        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <div id="" class="panel-body">
                    <form id="form-add-featured" data-parsley-validate action="" method="POST">
            ...
            <div class="panel-footer">
                <button id="button-add-featured" type="submit" class="btn btn-success m-r-5 m-b-5"><i class="fa fa-check"></i> Save</button>
...
<script>
        $(document).ready(function() {
            ...
            var add_featured;
            $("#form-add-featured").submit(function(event){
                if ($(this).parsley().isValid()) {
                    ...
                    add_featured = $.ajax({
                        url: "<?php echo MADMINURL ?>ajax/featured-add.php",
                        type: "post",
                        beforeSend: function(){ $("#button-add-featured").html('<i class="fa fa-spinner fa-pulse"></i> Saving...');$("#button-add-featured").attr('disabled','disabled');},
                        data: serializedData
                    });
                    add_featured.done(function (msg){
                        if(msg == 'true') {
                            $.gritter.add({
                                title:"Success!",
                            ...
                            $("#button-add-featured").removeAttr('disabled');
                            $("#button-add-featured").html('<i class="fa fa-check"></i> Save');
                            $.gritter.add({
