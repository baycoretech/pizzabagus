<?php
    ...
    $v_getPortfolio  = $o_getPortfolio->viewPortfolionameASC($pagelink);
?>
<div id="options" class="m-b-10">
    ...
    <div class="btn-group m-t-15 m-r-15 pull-right">
        <a id="sort-asc" href="<?php echo MADMINURL ?>/page/<?php echo $pagelink ?>/view-name-asc" class="btn btn-inverse active" title="Sort by name (ascending)"><i class="fa fa-sort-alpha-asc"></i></a>
