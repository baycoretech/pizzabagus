...
$config['authentication'] = function () {
    return isset($_SESSION['cr_adminID']) && $_SESSION['cr_adminPassword'];
};
...
$config['pluginsDirectory'] = $folder_path.'/cr-editor/plugins';
